...
function zoomed() {
    ...
    //g.call(rendertopo)
    g.call(renderplottiles,['233_49','234_49','233_48','234_48'
                           ,'235_49','236_49','235_50','236_50'])
}
...
function renderTiles2(svg, type) {
    ...
    .each(function(d) {
        var g = d3.select(this);
        this._xhr = d3.json("http://localhost:3000/" + type + "/"+d[2]+'/'+d[0]+'/'+d[1] + ".json", function(error, json) {
